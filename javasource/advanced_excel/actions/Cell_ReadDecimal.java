 ...
 */
public class Cell_ReadDecimal extends UserAction<java.math.BigDecimal>
{
	...
	public java.math.BigDecimal executeAction() throws Exception
	{
		...
		try
		{
			...
			logger.error("ERROR in Advanced_Excel.Cell_ReadDecimal: " + e.getMessage() + "\n" + e.toString(), e);
			return cellValue;
		}
		// END USER CODE
	}
