...
import ciphixscheduler.proxies.ENUM_Color;
 ...
 */
public class JAVA_Parse_Color extends UserAction<java.lang.String>
{
	private final java.lang.String toConvert;

	public JAVA_Parse_Color(
		IContext context,
	...
	{
		// BEGIN USER CODE
        Optional<ENUM_Color> result = this.enumFromString(ENUM_Color.class, toConvert);
