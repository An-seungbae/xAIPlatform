...
public class SendEmail extends UserAction<java.lang.Boolean>
{
	...
	public java.lang.Boolean executeAction() throws Exception
	{
		...
		MxMailMapper.setSendAccountConfigurations(this.EmailAccount, serverAccount, pk12Certificate, ldapConfiguration, getContext());
		MxMailMapper.setServerSendEmailMessage(this.EmailMessage, sendEmailMsg, attachments, getContext());
