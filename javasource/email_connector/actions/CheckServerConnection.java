...
public class CheckServerConnection extends UserAction<java.lang.Void>
{
	...
	public java.lang.Void executeAction() throws Exception
	{
		...
		if (this.EmailAccount.getisIncomingEmailConfigured() && !checkIncomingServerConnection(finalErrorMsg)) {
			throw new EmailConnectorException("Incoming server connection failed: " + finalErrorMsg);
		}
		if (this.EmailAccount.getisOutgoingEmailConfigured() && !checkOutgoingServerConnection(finalErrorMsg)) {
			throw new EmailConnectorException("Outgoing server connection failed: " + finalErrorMsg);
		}
		return null;
		// END USER CODE
	}
		...
		if(Boolean.TRUE.equals(this.EmailAccount.getisOutgoingEmailConfigured()) && !outgoingEmailAccounts.isEmpty()) {
			try
			{
				...
				if (outgoingEmailAccount.getOutgoingProtocol() == null)
					throw new EmailConnectorException(Error.EMPTY_SEND_PROTOCOL.getMessage());
				...
				MxMailMapper.setSendAccountConfigurations(this.EmailAccount, account,null,null,getContext());
				var emailServiceWorker = new EmailServiceWorker(account);
