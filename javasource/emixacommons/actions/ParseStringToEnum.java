 ...
 */
public class ParseStringToEnum extends UserAction<java.lang.Boolean>
{
	private final java.lang.String StringToParse;
	private final java.lang.String EnumName;
	private final IMendixObject EnumObject;

	public ParseStringToEnum(
		IContext context,
		java.lang.String _stringToParse,
		java.lang.String _enumName,
		IMendixObject _enumObject
	)
	{
		super(context);
		this.StringToParse = _stringToParse;
		this.EnumName = _enumName;
		this.EnumObject = _enumObject;
	}
	...
	public java.lang.Boolean executeAction() throws Exception
	{
		...
		if ( EnumObject.getMember( this.EnumName ) != null ) {
				...
				{						
					...
					for( IMetaEnumValue metaEnumValue : metaPrimitive.getEnumValues() )
					{
						...
						if ( metaEnumValue.getIdentifier().equals(StringToParse) ) {
							EnumObject.setValue(this.getContext(), EnumName, metaEnumValue.getIdentifier() );
							return true;
						}
					}
				}	
