...
/**
 * This JA will set the passed width and tumbnail width for a passed System.Image.
 */
public class CropImage extends UserAction<java.lang.Boolean>
{
	/** @deprecated use cropImgObj.getMendixObject() instead. */
	@java.lang.Deprecated(forRemoval = true)
	private final IMendixObject __cropImgObj;
	private final system.proxies.Image cropImgObj;
	private final java.lang.Long newWidth;
	private final java.lang.Long thumbnailWidth;

	public CropImage(
		IContext context,
		IMendixObject _cropImgObj,
		java.lang.Long _newWidth,
		java.lang.Long _thumbnailWidth
	)
	{
		super(context);
		this.__cropImgObj = _cropImgObj;
		this.cropImgObj = _cropImgObj == null ? null : system.proxies.Image.initialize(getContext(), _cropImgObj);
