...
/**
 * Determines the name of the current microflow, based on the level of stacktracing, then returns it.
 */
			...
			if (coreAction!=null){
				...
				if ((Level >= 0) && (Level < actionStackSize)){
					...
					if (nthCoreAction!=null){
						Core.getLogger(this.toString()).trace("nthCoreAction exists with name " + nthCoreAction.getMetaInfoJsonString());
